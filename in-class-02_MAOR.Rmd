...
```{r}
setwd("C:/Users/yaela/Dropbox (Brown)/Brown/R/week2/week-02-in-class-econ")
rain.df=data.frame(read.table("rnf6080.dat"))
...
````
The remaining 24 columns are the hours of the day.
...
```
We have negative values, which we shouldn't have.
